...
<hr>
<p><b>Authenticated User Id logout1:</b> <a href="<%=request.getContextPath()%>/logout1" title="Click here to log out"><%= request.getRemoteUser() %></a></p>
<p><b>Authenticated User Id logout2:</b> <a href="<%=request.getContextPath()%>/logout2" title="Click here to log out"><%= request.getRemoteUser() %></a></p>
